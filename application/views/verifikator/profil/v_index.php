                    ...
                    <div class="w3-col m12">
                        <div class="w3-card w3-round w3-white">
                            <div class="w3-container w3-padding">
                                ...
                                <a type="button" class="btn btn-primary" href="<?= site_url('verifikator/c_verifikator/edit'); ?>"><i class="fa fa-pencil"></i> Edit</a>
                                <a type="button" class="btn btn-secondary" href="<?= site_url('verifikator/c_verifikator/ubahpassword'); ?>"><i class="fa fa-key"></i> Ubah Password</a>
                            </div>
                        </div>
                    </div>
                </div>
