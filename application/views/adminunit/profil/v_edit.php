    ...
    <div class="d-sm-flex  justify-content-between mb-0 ml-5">
        <div class="col-lg-8 mb-4">
            <div class="card border-bottom-primary shadow mb-4">
                ...
                <form action="<?= base_url('adminunit/c_adminunit/edit'); ?>" name="myForm" method="POST" onsubmit="return validateForm()">
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Unit Kerja</label>
                                <input type="text" class="form-control" id="nama_unit" name="nama_unit" value="<?= $getpegawai['nama_unit']; ?>" readonly>
                            </div>
